...
const SubnetCalculatorPage: React.FC = () => {
  ...
  return (
    <>
      <SEO
        name="Kalkulator Subnet IPv4 | BASIS-64"
        description="Hitung subnetting IPv4 secara instan. Dapatkan informasi lengkap mengenai IP Network, Broadcast, Host Range, Netmask, hingga CIDR untuk efisiensi jaringan Anda."
        keys="kalkulator subnet, subnetting ipv4, hitung ip address, cidr calculator, network broadcast calculator, alat jaringan basis-64"
        thumbnail="https://basis64.com/thumbnails/subnetting.webp"
      />
