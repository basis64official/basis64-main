...
const Contact = () => {
  return (
    <>
      <SEO
        name="Hubungi Kami | BASIS-64 Official Support"
        description="Hubungi tim BASIS-64 melalui WhatsApp, Email, Instagram, atau Discord. Kami siap membantu pertanyaan, kerja sama, dan masukan Anda."
        keys="kontak basis64, whatsapp basis64, discord basis64, layanan pelanggan dayak kenyah, email basis64"
      />
      <div className='p-4'>
