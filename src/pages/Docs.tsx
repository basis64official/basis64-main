...
export default function Docs() {
  ...
  return (
    <>
      <SEO
        name="Dokumentasi & Panduan Penggunaan | BASIS-64"
        description="Pelajari cara menggunakan penerjemah BASIS-64, fitur utama, pertanyaan umum (FAQ), serta catatan perubahan (changelog) terbaru layanan kami."
        keys="dokumentasi basis-64, panduan terjemahan dayak, cara translate bahasa dayak kenyah, changelog basis-64, faq basis-64"
      />
